...
require('./form_request'); //TODO this doesn't work in plain js
...
$(function() {
    ...
    // View records - pick from drop down;
    $()

    $('#buttonEdit').click(function {
        //opens the form for editing the current record;
    ...
    $('#buttonSave').click(function {
        if (sendWarning('Delete') === false) return;

        var requestBody = buildRequest(); // return handled in ajax request
...
function clearForm(form) {
  $(':input', form).each(function() { // iterate over the form
    var type = this.type;
